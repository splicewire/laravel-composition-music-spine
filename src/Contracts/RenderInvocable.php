 ...
 * importable surface. The render artifact is target-specific, hence `mixed`: the caller that resolved a
 * concrete binding knows the concrete type (a `MidiFile` for the MIDI arranger).
 */
